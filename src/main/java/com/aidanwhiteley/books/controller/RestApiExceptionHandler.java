...
public class RestApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ApiExceptionData handleAccessDeniedForbiddenException(Exception ex, WebRequest request) {
        ...
        return new ApiExceptionData(FORBIDDEN.value(),
    ...
    public ApiExceptionData handleNotFoundException(Exception ex, WebRequest request) {
        ...
        return new ApiExceptionData(NOT_FOUND.value(),
    ...
    public ApiExceptionData handleIllegalArgumentException(Exception ex, WebRequest request) {
        ...
        return new ApiExceptionData(BAD_REQUEST.value(),
     ...
     * <p>
     * It also logs the exception. The other exception handlers expect the problem to have
     * been logged close to where it was initially caught. In this case, it is likely that the
     * exception may not have already been logged so it is logged here.
     */
